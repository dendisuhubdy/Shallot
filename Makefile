...
all:
	...
	gcc -O3 -Wall -L/usr/local/lib -pthread -lm -lpthread -lssl -lcrypto -o shallot src/math.o src/error.o src/print.o src/linux.o src/thread.o src/shallot.o
debug:
	...
	gcc -g -O3 -Wall -L/usr/local/lib -pthread -lm -lpthread -lssl -lcrypto -o shallot src/math.o src/error.o src/print.o src/linux.o src/thread.o src/shallot.o
clean:
	rm -f shallot src/math.o src/error.o src/print.o src/linux.o src/thread.o src/shallot.o
